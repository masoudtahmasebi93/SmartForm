...
{
    public class UpdateFormHandler : ICommandHandler<UpdateForm>
    {
        private readonly IBusClient _busClient;
        private readonly IFormService _formService;
        private readonly ILogger _logger;

        public UpdateFormHandler(IBusClient busClient, IFormService formService,
            ILogger<UpdateFormHandler> logger)
        {
